...
$modversion['blocks'][$i]['name'] = _MI_TAD_HONOR_LIST_BLOCK_NAME;
$modversion['blocks'][$i]['description']  = _MI_TAD_HONOR_LIST_BLOCK_DESC;
...
$modversion['blocks'][$i]['name'] = _MI_TAD_HONOR_MARQUEE_BLOCK_NAME;
$modversion['blocks'][$i]['description']  = _MI_TAD_HONOR_MARQUEE_BLOCK_DESC;
