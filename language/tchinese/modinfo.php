...
define('_MI_TAD_HONOR_LIST_BLOCK_NAME' , '最新榮譽榜');
define('_MI_TAD_HONOR_LIST_BLOCK_DESC' , '最新榮譽榜區塊 (tad_honor_list)');

define('_MI_TAD_HONOR_MARQUEE_BLOCK_NAME' , '榮譽榜跑馬燈');
define('_MI_TAD_HONOR_MARQUEE_BLOCK_DESC' , '榮譽榜跑馬燈區塊 (tad_honor_marquee)');
